...
# දත්ත සහ විස්තර (ඔයා දුන් පිළිවෙලට අනුව)
questions_list = [
    ...
    {"q_no": 15, "file": "20", "answer": "ඇලෙක්සැන්ඩර් ෆ්ලෙමින්", "info": "පෙනිසිලින් (Penicillin) නම් ලොව ප්‍රථම ප්‍රතිජීවක ඖෂධය සොයාගත්තේය."}
]
...
if st.session_state.current_index < len(questions_list):
    ...
    with col2:
        ...
        if not st.session_state.show_info:
            ...
            # පිළිතුර නිවැරදිද වැරදිද යන්න සහ විස්තරය පෙන්වීම
            if user_choice == correct_answer:
